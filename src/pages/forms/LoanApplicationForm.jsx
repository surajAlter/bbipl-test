...
// import { LoanFormUpload } from '../../api/LoanFormUpload';
...
//         //if no error on form submission
//         // LoanFormUpload(formData);
//         console.log(e)
...
//                             <select name="maritalStatus" className="w-full p-2 border border-gray-300 rounded-md">
...
//                     {/* Conditional Rental Info - Slide-in Effect */}
//                     {/* <div className="space-y-4" id="rentalInfo" style={{ display: "none" }}>
//                         <div className="space-y-2">
//                             <label htmlFor="permanentAddress" className="block text-sm font-medium text-gray-700">Permanent Address (if rented)</label>
//                             <input id="permanentAddress" name="permanentAddress" className="w-full p-2 border border-gray-300 rounded-md" />
//                         </div>
//                         <div className="space-y-2">
//                             <label htmlFor="monthlyRent" className="block text-sm font-medium text-gray-700">Monthly Rent Amount</label>
//                             <input id="monthlyRent" name="monthlyRent" type="number" className="w-full p-2 border border-gray-300 rounded-md" />
//                         </div>
//                     </div> */}
...
//                             <div className="space-y-2">
//                                 <label htmlFor="officeMail" className="block text-sm font-medium text-gray-700">Office Mail ID</label>
//                                 <input id="officeMail" name="officeMail" type="email" className="w-full p-2 border border-gray-300 rounded-md" required />
//                             </div>
//                             <div className="space-y-2">
//                                 <label htmlFor="personalMail" className="block text-sm font-medium text-gray-700">Personal Mail ID</label>
//                                 <input id="personalMail" name="personalMail" type="email" className="w-full p-2 border border-gray-300 rounded-md" required />
//                             </div>
//                         </div>
//                         <div className="grid gap-4 md:grid-cols-2 mt-2">
//                             <div className="space-y-2">
//                                 <label htmlFor="education" className="block text-sm font-medium text-gray-700">Educational Qualification</label>
//                                 <input id="education" name="education" className="w-full p-2 border border-gray-300 rounded-md" required />
//                             </div>
//                             <div className="space-y-2">
//                                 <label htmlFor="prevCompany" className="block text-sm font-medium text-gray-700">Previous Company Name</label>
//                                 <input id="prevCompany" name="prevCompany" className="w-full p-2 border border-gray-300 rounded-md" required />
//                             </div>
//                         </div>
//                         <div className="grid gap-4 md:grid-cols-2 mt-2">
//                             <div className="space-y-2">
//                                 <label htmlFor="salary" className="block text-sm font-medium text-gray-700">Net Salary</label>
//                                 <input id="salary" name="salary" type="number" className="w-full p-2 border border-gray-300 rounded-md" required />
//                             </div>
//                             <div className="space-y-2">
//                                 <label htmlFor="designationSenior" className="block text-sm font-medium text-gray-700">Designation Senior</label>
//                                 <input id="designationSenior" name="designationSenior" className="w-full p-2 border border-gray-300 rounded-md" required />
//                             </div>
//                         </div>
//                     </div>
...
//                             <label htmlFor="loanDetails" className="block text-sm font-medium text-gray-700">Old Loan Details (if any)</label>
//                             <input id="loanDetails" name="loanDetails" className="w-full p-2 border border-gray-300 rounded-md" required />
//                         </div>
//                     </div>
